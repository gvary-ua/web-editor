...
- [Web editor](#web-editor)
  ...
  - [Connecting with server locally](#connecting-with-server-locally)
  - [Editor JS setup](#editor-js-setup)
    ...
    - [Block data](#block-data)
      ...
      - [List data](#list-data)
      - [Checkist data](#checkist-data)
      - [Table data](#table-data)
      - [Delimiter data](#delimiter-data)
    - [Strikethrough data (\<s class="cdx-strikethroughs"\>)](#strikethrough-data-s-classcdx-strikethroughs)
    - [Underline data (\<u class="cdx-underline"\>)](#underline-data-u-classcdx-underline)
...
- `nvm use lts/iron` - set Node version that we use
...
## Connecting with server locally

Please read web-reader documentation on how to start the application. But the most important note is that both applications must work on the same domain either localhost or 127.0.0.1, (I prefer localhost). Meaning SPA will run on localhost:3000, MPA on localhost:8000. It's important for cookies!
...
| Checklist      | [@editorjs/checklist](https://github.com/editor-js/checklist)     | 1.0.0                | ✅                |
...
### Strikethrough data (<s class=\"cdx-strikethroughs\">)
...
### Underline data (<u class=\"cdx-underline\">)
